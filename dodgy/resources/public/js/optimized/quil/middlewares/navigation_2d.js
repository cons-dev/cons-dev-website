...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__7234_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_7235 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_7236 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_7235);
var pos_7237 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_7235);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_7236);

var tr__7011__auto___7238 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_7236) - cljs.core.first(pos_7237)),(((quil.core.height() / (2)) / zoom_7236) - cljs.core.second(pos_7237))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__7011__auto___7238);
...
var G__7239 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__7240 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__7239,G__7240) : user_mouse_dragged.call(null,G__7239,G__7240));
...
return (function (state,event){
var G__7241 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__7242 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__7241,G__7242) : user_mouse_wheel.call(null,G__7241,G__7242));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
