...
return cljs.core.merge.call(null,initial_state,p1__2854_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_2855 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_2856 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_2855);
var pos_2857 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_2855);
quil.core.scale.call(null,zoom_2856);

var tr__2668__auto___2858 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_2856) - cljs.core.first.call(null,pos_2857)),(((quil.core.height.call(null) / (2)) / zoom_2856) - cljs.core.second.call(null,pos_2857))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__2668__auto___2858);
