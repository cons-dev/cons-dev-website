...
var vec__2803 = axis;
var a_x = cljs.core.nth.call(null,vec__2803,(0),null);
var a_y = cljs.core.nth.call(null,vec__2803,(1),null);
var a_z = cljs.core.nth.call(null,vec__2803,(2),null);
var vec__2806 = v;
var x = cljs.core.nth.call(null,vec__2806,(0),null);
var y = cljs.core.nth.call(null,vec__2806,(1),null);
var z = cljs.core.nth.call(null,vec__2806,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__2809,p__2810){
var vec__2811 = p__2809;
var u1 = cljs.core.nth.call(null,vec__2811,(0),null);
var u2 = cljs.core.nth.call(null,vec__2811,(1),null);
var u3 = cljs.core.nth.call(null,vec__2811,(2),null);
var vec__2814 = p__2810;
var v1 = cljs.core.nth.call(null,vec__2814,(0),null);
var v2 = cljs.core.nth.call(null,vec__2814,(1),null);
var v3 = cljs.core.nth.call(null,vec__2814,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__2817_SHARP_){
return (p1__2817_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__2818_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__2819_SHARP_,angle_lr),angle_ud);
...
var map__2821 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__2821__$1 = (((((!((map__2821 == null))))?(((((map__2821.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2821.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2821):map__2821);
var up = cljs.core.get.call(null,map__2821__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__2821__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5733__auto__ = (function (){var pred__2823 = cljs.core._EQ_;
var expr__2824 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__2823.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__2824))){
return straight;
} else {
if(cljs.core.truth_(pred__2823.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__2824))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__2823.call(null,quil.middlewares.navigation_3d.space,expr__2824))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__2823.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__2824))){
return up;
} else {
if(cljs.core.truth_(pred__2823.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__2824))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__2823.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__2824))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5733__auto__,map__2821,map__2821__$1,up,straight){
return (function (p1__2820_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__2820_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5733__auto__,map__2821,map__2821__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__2826_SHARP_);
});})(initial_state))
);
});
/**
...
var map__2827_2838 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__2827_2839__$1 = (((((!((map__2827_2838 == null))))?(((((map__2827_2838.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2827_2838.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2827_2838):map__2827_2838);
var vec__2828_2840 = cljs.core.get.call(null,map__2827_2839__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_2841 = cljs.core.nth.call(null,vec__2828_2840,(0),null);
var c_y_2842 = cljs.core.nth.call(null,vec__2828_2840,(1),null);
var c_z_2843 = cljs.core.nth.call(null,vec__2828_2840,(2),null);
var vec__2831_2844 = cljs.core.get.call(null,map__2827_2839__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_2845 = cljs.core.nth.call(null,vec__2831_2844,(0),null);
var u_y_2846 = cljs.core.nth.call(null,vec__2831_2844,(1),null);
var u_z_2847 = cljs.core.nth.call(null,vec__2831_2844,(2),null);
var vec__2834_2848 = cljs.core.get.call(null,map__2827_2839__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_2849 = cljs.core.nth.call(null,vec__2834_2848,(0),null);
var p_y_2850 = cljs.core.nth.call(null,vec__2834_2848,(1),null);
var p_z_2851 = cljs.core.nth.call(null,vec__2834_2848,(2),null);
quil.core.camera.call(null,p_x_2849,p_y_2850,p_z_2851,(p_x_2849 + c_x_2841),(p_y_2850 + c_y_2842),(p_z_2851 + c_z_2843),u_x_2845,u_y_2846,u_z_2847);
